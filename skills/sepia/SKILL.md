...
- **Deletion beats addition** (74% replace / 18% delete / 8% insert). The only additive fix is real specificity, and no register drift: a rewrite must not come out more promotional than its source, nor with a smaller share of content words (refactor row).
