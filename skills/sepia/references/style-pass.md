...
| Punctuation density, or a comma/period count | Measured directions contradict: on one Chinese Q&A corpus, punctuation density reads 0.135 human vs 0.136 ChatGPT (Z) while the punctuation share of tokens reads 16.0% vs 13.4% (Guo et al. 2023, same corpus); in English news the human share is 11.88% against 10.77–12.14% for four base models, one of them above human (M). No per-type human-vs-LLM count (comma, period, semicolon) exists for English or Chinese. The English pipeline that Pangram described in its 2025 workshop paper (a 12B-parameter classifier) lower-cased and unidecode-normalized input before scoring, so glyph choice never reached the model; its 2026 architecture is different and its preprocessing undescribed. What a detector of that kind reads is distributional, not typographic |
